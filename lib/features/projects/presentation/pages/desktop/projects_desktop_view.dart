...
class ProjectsDesktopView extends StatelessWidget {
  ...
  const ProjectsDesktopView({super.key, required this.scrollOffsetListenable});
      ...
      builder: (context, state) {
        ...
        return ValueListenableBuilder<double>(
          ...
          builder: (context, scrollOffset, _) {
            ...
            // Better breakpoints logic similar to original
              ...
              child: Stack(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      // Header (Identical to Mobile but spacing differs)
